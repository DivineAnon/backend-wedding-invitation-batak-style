...
@section('page_title', 'Edit Halaman Kontak')
@section('breadcrumb', 'Konten / Kontak / Pengaturan Halaman')

@section('content')
    <form action="{{ route('admin.kontak.page.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div>
                <div class="card">
                    <div class="card__header">
                        ...
                        <span style="font-size:12px;color:var(--muted)">Gambar header untuk halaman kontak</span>
                    </div>
                    <div class="card__body">
                        <div class="form-group">
                            ...
                            @if ($page->hero_image)
                                <div id="current-hero" style="margin-bottom:10px">
                                    <img src="{{ media_url($page->hero_image, 'assets/kontak') }}" alt="Hero image"
                        ...
                        <div class="form-group" style="margin-top:20px">
                            <label class="form-label" for="accent_text">Accent Text (teks hero)</label>
                            ...
                            @error('accent_text')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                            <p style="font-size:11px;color:var(--muted);margin-top:4px">Teks yang ditampilkan di bagian hero halaman Kontak. Kosongkan untuk menggunakan teks default.</p>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card__body" style="font-size:13px;color:var(--muted);line-height:1.6">
                        <p style="margin:0 0 12px">
                            <strong style="color:var(--text)">Hero Image</strong> adalah gambar header yang ditampilkan di bagian atas halaman Kontak di bagian public website.
                        </p>
                        <p style="margin:0 0 12px">
                            Gambar ini akan terlihat oleh semua pengunjung halaman kontak.
                        </p>
                        <p style="margin:0">
