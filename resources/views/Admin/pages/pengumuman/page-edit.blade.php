...
@section('title', 'Edit Halaman Pengumuman')
@section('page_title', 'Edit Halaman Pengumuman')
@section('breadcrumb', 'Konten / Pengumuman / Pengaturan Halaman')

@section('content')
    <form action="{{ route('admin.pengumuman.page.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div>
                <div class="card">
                    <div class="card__header">
                        ...
                        <span style="font-size:12px;color:var(--muted)">Gambar header untuk halaman pengumuman</span>
                    </div>
                    <div class="card__body">
                        <div class="form-group">
                            ...
                            @if ($page->hero_image)
                                <div id="current-hero" style="margin-bottom:10px">
                                    <img src="{{ media_url($page->hero_image, 'assets/pengumuman') }}" alt="Hero image"
                        ...
                        <div class="form-group" style="margin-top:20px">
                            ...
                            <input type="text" name="accent_text" id="accent_text"
                                ...
                                placeholder="Informasi penting dan warta terkini untuk umat">
                            @error('accent_text')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                ...
                <div class="card">
                    ...
                    <div class="card__body" style="font-size:13px;color:var(--muted);line-height:1.6">
                        <p style="margin:0 0 12px">
                            <strong style="color:var(--text)">Hero Image</strong> adalah gambar header yang ditampilkan di bagian atas halaman Pengumuman di bagian public website.
                        </p>
                        <p style="margin:0 0 12px">
                            Gambar ini akan terlihat oleh semua pengunjung halaman pengumuman.
                        </p>
                        <p style="margin:0">
