...
@section('title', 'Pengaturan Halaman Berita')
@section('page_title', 'Pengaturan Halaman Berita')
@section('breadcrumb', 'Konten / Berita / Pengaturan Halaman')

@section('content')
    <form action="{{ route('admin.berita.page.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div>
                <div class="card">
                    <div class="card__header">
                        ...
                        <span style="font-size:12px;color:var(--muted)">Gambar header untuk halaman Berita</span>
                    </div>
                    <div class="card__body">
                        <div class="form-group">
                            ...
                            @if ($page->hero_image)
                                <div id="current-hero" style="margin-bottom:10px">
                                    <img src="{{ media_url($page->hero_image, 'assets/berita') }}" alt="Hero image"
                        ...
                        <div class="form-group" style="margin-top:20px">
                            ...
                            <input type="text" name="accent_text" id="accent_text"
                                ...
                                placeholder="Warta terkini dari Paroki Santo Yoseph Matraman">
                            @error('accent_text')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                ...
                <div class="card">
                    ...
                    <div class="card__body" style="font-size:13px;color:var(--muted);line-height:1.6">
                        <p style="margin:0 0 12px">
                            <strong style="color:var(--text)">Hero Image</strong> adalah gambar header yang ditampilkan di bagian atas halaman Berita di bagian public website.
                        </p>
                        <p style="margin:0 0 12px">
                            <strong style="color:var(--text)">Accent Text</strong> adalah teks yang ditampilkan di sisi kanan hero sebagai penjelasan singkat halaman.
                        </p>
                        <p style="margin:0">
...
function previewHeroImage(input) {
    ...
    const previewImg = document.getElementById('hero_image-preview-img');
