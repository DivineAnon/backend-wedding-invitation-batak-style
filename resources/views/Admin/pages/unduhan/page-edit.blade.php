...
@section('title', 'Edit Halaman Unduhan')
@section('page_title', 'Edit Halaman Unduhan')
@section('breadcrumb', 'Konten / Unduhan / Pengaturan Halaman')

@section('content')
    <form action="{{ route('admin.unduhan.page.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div>
                <div class="card">
                    <div class="card__header">
                        ...
                        <span style="font-size:12px;color:var(--muted)">Gambar header untuk halaman unduhan</span>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ($page->hero_image)
                                <div id="current-hero" style="margin-bottom:10px">
                                    <img src="{{ media_url($page->hero_image, 'assets/unduhan') }}" alt="Hero image"
                ...
                <div class="card">
                    ...
                    <div class="card__body" style="font-size:13px;color:var(--muted);line-height:1.6">
                        <p style="margin:0 0 12px">
                            <strong style="color:var(--text)">Hero Image</strong> adalah gambar header yang ditampilkan di bagian atas halaman Unduhan di bagian public website.
                        </p>
                        <p style="margin:0 0 12px">
                            Gambar ini akan terlihat oleh semua pengunjung halaman unduhan.
                        </p>
                        <p style="margin:0">
