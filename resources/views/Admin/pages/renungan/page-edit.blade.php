...
@section('title', 'Edit Halaman Renungan')
@section('page_title', 'Edit Halaman Renungan')
@section('breadcrumb', 'Konten / Renungan / Pengaturan Halaman')

@section('content')
    <form action="{{ route('admin.renungan.page.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div>
                <div class="card">
                    <div class="card__header">
                        ...
                        <span style="font-size:12px;color:var(--muted)">Gambar header untuk halaman renungan</span>
                    </div>
                    <div class="card__body">
                        <div class="form-group">
                            ...
                            @if ($page->hero_image)
                                <div id="current-hero" style="margin-bottom:10px">
                                    <img src="{{ media_url($page->hero_image, 'assets/renungan') }}" alt="Hero image"
                        ...
                        <div class="form-group" style="margin-top:20px">
                            ...
                            <input type="text" name="accent_text" id="accent_text"
                                ...
                                placeholder="Sabda yang menghidupkan jiwa dan iman kita">
                            @error('accent_text')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                        ...
                        <div style="margin-top:24px;display:flex;gap:8px">
                            ...
                            <a href="{{ route('admin.renungan.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card__body" style="font-size:13px;color:var(--muted);line-height:1.6">
                        <p style="margin:0 0 12px">
                            <strong style="color:var(--text)">Hero Image</strong> adalah gambar header yang ditampilkan di bagian atas halaman Renungan di bagian public website.
                        </p>
                        <p style="margin:0 0 12px">
                            Gambar ini akan terlihat oleh semua pengunjung halaman renungan.
                        </p>
                        <p style="margin:0">
